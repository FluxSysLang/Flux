...
namespace standard
{
    namespace math
    {
        ...
        const float PIF = 3.14159265358979f,
                    PI_2_F = 1.5707963267948966f,
                    PI_4_F = 0.7853981633974483f,
                    TAU_F = 6.283185307179586f,
                    SQRT2_F = 1.4142135623730951f,
                    SQRT1_2_F = 0.7071067811865475f,
                    LN2_F = 0.6931471805599453f,
                    LN10_F = 2.302585092994046f,
                    LOG2E_F = 1.4426950408889634f,
                    LOG10E_F = 0.4342944819032518f,
                    INFINITY_F = (float)0x7F800000u,
                    NAN_F = (float)0x7FC00000u;

        const double PID = 3.14159265358979323846,
                     PI_2_D = 1.5707963267948966,
                     PI_4_D = 0.7853981633974483,
                     TAU_D = 6.283185307179586,
                     SQRT2_D = 1.4142135623730951,
                     SQRT1_2_D = 0.7071067811865475,
                     LN2_D = 0.6931471805599453,
                     LN10_D = 2.302585092994046,
                     LOG2E_D = 1.4426950408889634,
                     LOG10E_D = 0.4342944819032518,
                     INFINITY_D = (double)0x7FF0000000000000u,
                     NAN_D = (double)0x7FF8000000000000u;
