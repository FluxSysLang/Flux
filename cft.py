...
"""
cftranslate.py - C to Flux translation layer
Uses libclang to parse C headers/sources and emits equivalent Flux declarations
and function bodies.

Usage:
    python cftranslate.py <input.c|h> [output.fx]
    python cftranslate.py <input.c|h>        # prints to stdout
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: cftranslate.py <input.c|h> [output.fx]", file=sys.stderr)
        sys.exit(1)
